            ...
            {isLoading ? (
              ...
              <>
                <TableRow
                  ...
                  <TableCell
                    colSpan={
                      reviewerMode ? headCells.length + 1 : headCells.length
                    }
                    align="center">
              ...
              <>
                {stableSort(participants, getComparator(order, orderBy)).map(
                  (row, index) => {
                    ...
                    return (
                      <TableRow
                        ...
                        <TableCell>
                          <div className={css.textContainer}>{row.email}</div>
                        </TableCell>
                        <TableCell>{row.phone}</TableCell>
                        <TableCell>{moment(row.DOB).format('L')}</TableCell>
